...
SET 
user_password = $1
WHERE user_uuid = $2::uuid AND user_deleted_at IS NULL RETURNING user_id, user_uuid, user_email, user_fullname, user_password, user_age, user_status, user_level, user_deleted_at, user_created_at, user_updated_at
`
